...
var createResizeDetector__default = /*#__PURE__*/ _interopDefaultLegacy(
  createResizeDetector
);
var isShallowEqual__default = /*#__PURE__*/ _interopDefaultLegacy(
  isShallowEqual
);
...
var renderWrapper = function renderWrapper(WrappedComponent) {
  function SizeMeRenderer(props) {
    ...
    props.onSize;
    var restProps = _objectWithoutProperties(props, [
      "explicitRef",
      "className",
      "style",
      "size",
    ...
    var SizeAwareComponent = /*#__PURE__*/ (function (_React$Component) {
      ...
      function SizeAwareComponent() {
        ...
        _defineProperty(
          ...
          "strategisedGetState",
          function () {
            return _this.strategy === "callback"
              ? _this.callbackState
              : _this.state;
          }
        );
        ...
        _defineProperty(
          _assertThisInitialized(_this),
          "checkIfSizeChanged",
          refreshDelayStrategy(refreshRate, function (el) {
  ...
  _createClass(SizeMe, [
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        _this$props.render;
        var currentSizeMeConfig = _objectWithoutProperties(_this$props, [
          "children",
          "render",
        ]);
        ...
        prevProps.children;
        prevProps.render;
        var prevSizeMeConfig = _objectWithoutProperties(prevProps, [
          "children",
          "render",
        ]);
